...
class TestStockAvailableLocationOrderpointTemplate(TestLocationOrderpointCommon):
    ...
    def test_available_on_replenish(self):
        ...
        move = self._create_outgoing_move(12, product=self.product)
        move = self._create_outgoing_move(1, product=self.product)
        self.assertEqual(move.state, "confirmed")
        self._create_outgoing_move(10, product=self.product_2)
        self._create_outgoing_move(1, product=self.product_2)
        self.template.invalidate_recordset()
    ...
    def test_available_on_multi_replenish(self):
        ...
        move = self._create_outgoing_move(10, product=self.product_2)
        move = self._create_outgoing_move(1, product=self.product_2)
        self.assertEqual(move.state, "confirmed")
        self.template.invalidate_recordset()
    ...
    def test_available_on_one_shelf_location(self):
        ...
        ) = self._create_orderpoint_complete("Shelf Replenishment", trigger="manual", location_dest=self.shelf)
        ...
        move = self._create_outgoing_move(2, product=self.product, location=self.shelf)
        self.assertEqual(move.state, "confirmed")

        move = self._create_outgoing_move(5, product=self.product_2, location=self.shelf)
        self.assertEqual(move.state, "confirmed")
        self.template.invalidate_recordset()
        self.assertEqual(
            2.0,
    ...
    def test_available_on_different_sublocation(self):
        ...
        move = self._create_outgoing_move(1,product=self.product_2, location=self.area_1)
        self.assertEqual(move.state, "confirmed")

        move = self._create_outgoing_move(3,product=self.product_2, location=self.area_2)
        self.assertEqual(move.state, "confirmed")
